...
$strAccessToken = "IepY9vTAZPsfZ0+EaNPqmB51bK6JNxDsQ7aDB5QxVi4VU8GfoEXJQ+5y3fJ+2vv9fZFR6gBGpP1cMMjBe+K+q5NLSELAV431uCWujCbBWYMwB3pgCbqCoVSG34+EYvyaCHXIzLqB4QP8O/pWWwLsGgdB04t89/1O/w1cDnyilFU=";
...
$_answers  = str_replace($rudeword, $replace, $_answer);
    ...
    $arrPostData['messages'][0]['text'] = 'มิยูกิ No.01 Serial Number MYK-01171162 ถูกระงับการสอนชั่วคราว ^^';
...

{
  ...
  curl_setopt($ch2, CURLOPT_URL, 'https://api.wunderground.com/api/824f359fd94bfb94/forecast/lang:TH/q/Thailand/Bangkok.json');
